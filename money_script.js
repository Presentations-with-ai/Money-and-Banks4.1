...
function buildTelegramResultsReportChunks(entry) {
  ...
  const allLines = [...headerLines, '', 'Ответы по номерам из JSON:', ...answerLines];
...
function getThemeLabel(fileName) {
  const map = {
    ...
    'dengi_i_banki_tests_part_6.json': 'Вопросы 251-288',
...
<div class="card">
    ...
    <div class="row">
        <select id="theme-select">
            ...
            <option value="dengi_i_banki_tests_part_6.json">Вопросы 251-288</option>
